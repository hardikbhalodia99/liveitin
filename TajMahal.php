...
<body>
  ...
  <div id="carouselExampleCaptions" class="carousel slide carousel-fade  " data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="images//TajMahal.jpg" class="d-block w-100 h-100">
      ...
      <div class="carousel-item">
        <img src="images//taj3.jpg" class="d-block w-100 h-100">
      ...
      <div class="carousel-item">
        <img src="images//taj.jpg" class="d-block w-100 h-100">
  ...
  <div class="container-fluid text-center">
    <div class=" bg-light changeStyle">
      ...
      <a type="button" href="tripPlan2.html" class="btn btn-warning btn-lg ">SCHEDULE A TRIP</a>
    </div>
  ...
  <div class="text-center event-headings">
    <B>
      <h2>Wel-CoMe To ThE wOrlD's BiGgEsT GraVe EveR BuilT</h2>
    </B>
  ...
  <div class="row container-fluid" style="margin:auto">
    <div class="card mb-4 bg-light border-light">
      <div class="row no-gutters">
        <div class="col-md-7">
          <img src="images//taj4.jpg" class="card-img" alt="...">
        </div>
        <div class="col-md-5">
          <div class="card-body">
            ...
            <h5>Come, Walk along the pathway beside the reflecting pool with fountains upto the mausoleum crafted in soft &amp; 
                pure marble and jewelled with semi precious stones, where in the serenity of paradise rests the
                 Queen in peace with her King. Come to unfold the pages from the past to churn the charm out of its mystique and 
                enrich your imagination about this marvel of an epic in stone, The Taj! </h>
            </p>
  ...
  <div class="row container-fluid " style="margin:auto">
    <div class="card mb-4 bg-light border-light">
      <div class="row no-gutters">
        <div class="col-md-5 ">
          <img src="images/taj5.jpg" class="card-img" alt="...">
        </div>
        <div class="col-md-7">
          <div class="card-body">
            <h5 class="card-title display-4 ">Enjoyfull Miami<svg width="1em" height="1em" viewBox="0 0 16 16"
  ...
  <div class="row container-fluid" style="margin:auto">
    <div class="card mb-4 bg-light border-light">
      <div class="row no-gutters">
        <div class="col-md-8">
          <img src="images//taj7.jpg" class="card-img" alt="...">
        </div>
        <div class="col-md-4">
          <div class="card-body">
